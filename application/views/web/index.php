...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<!--//tags -->
	<link href="<?php echo base_url(); ?>assets/include/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
	<link href="<?php echo base_url(); ?>assets/include/css/style.css" rel="stylesheet" type="text/css" media="all" />
	<link href="<?php echo base_url(); ?>assets/include/css/font-awesome.css" rel="stylesheet">
	<!--pop-up-box-->
	<link href="<?php echo base_url(); ?>assets/include/css/popuo-box.css" rel="stylesheet" type="text/css" media="all" />
	<!--//pop-up-box-->
	<!-- price range -->
	<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/include/css/jquery-ui1.css">
	<!-- fonts -->
...
<body>
	...
	<div class="header-most-top">
		<p>Kirana Offer Zone Top Deals & Discounts</p>
	</div>
	<!-- //top-header -->
	<!-- header-bot-->
			...
			<div class="col-md-4 logo_agile">
				<h1>
					<a href="index.html">
						<span>K</span>irana
						<span>S</span>hop
						<img src="<?php echo base_url(); ?>assets/include/images/logo2.png" alt=" ">
					</a>
				</h1>
			</div>
			<!-- header-bot -->
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu multi-column columns-3">
										<div class="agile_inner_drop_nav_info">
											...
											<div class="col-sm-4 multi-gd-img">
												<img src="<?php echo base_url(); ?>assets/include/images/nav.png" alt="">
											</div>
											<div class="clearfix"></div>
										</div>
									</ul>
		...
		<div class="container">
			...
			<div class="side-bar col-md-3">
				...
				<div class="deal-leftmk left-side">
					...
					<?php foreach($special_products as $featured_images): ?>
					<div class="special-sec1">
						<div class="col-xs-4 img-deals">
							<img src="<?php echo base_url(); ?>assets/include/images/products/specialproduct/<?php echo $featured_images['image']; ?>" alt="">
						</div>
			...
			<div class="agileinfo-ads-display col-md-9">
				<div class="wrapper">
					...
					<div class="product-sec1">
						...
						<?php foreach($product_featured_images_nuts as $featured_images): ?>
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="<?php echo base_url(); ?>assets/include/images/products/<?php echo $featured_images['category'].'/'.$featured_images['image']; ?>" alt="">
					...
					<div class="product-sec1 product-sec2">
						...
						<div class="col-xs-5 bg-right-nut">
							<img src="<?php echo base_url(); ?>assets/include/images/nut1.png" alt="">
						</div>
						<div class="clearfix"></div>
					</div>
					<!-- //second section (nuts special) -->
					...
					<div class="product-sec1">
						...
						<?php foreach($product_featured_images_oil as $featured_images): ?>
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="<?php echo base_url(); ?>assets/include/images/products/<?php echo $featured_images['category'].'/'.$featured_images['image']; ?>" alt="">
								...
								<div class="item-info-product ">
									...
									<div class="info-product-price">
										<span class="item_price">Rs. 78</span>
										<del>Rs. 110</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
					...
					<div class="product-sec1">
						<h3 class="heading-tittle">Packaged food</h3>
						
						<?php foreach($product_featured_images_Packagedfood as $featured_images): ?>
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="<?php echo base_url(); ?>assets/include/images/products/<?php echo $featured_images['category'].'/'.$featured_images['image']; ?>" alt="">
								...
								<div class="item-info-product ">
									...
									<div class="info-product-price">
										<span class="item_price">Rs. 15</span>
										<del>Rs. 25</del>
									</div>
									<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
										<form action="#" method="post">
	...
	<div class="featured-section" id="projects">
		<div class="container">
			...
			<div class="content-bottom-in">
				<ul id="flexiselDemo1">
				<?php foreach($special_offer as $featured_images): ?>
					<li>
				...
				<?php  endforeach; ?>
						<div class="w3l-specilamk">
							<div class="speioffer-agile">
								<a href="single2.html">
									<img src="<?php echo base_url(); ?>assets/include/images/s9.jpg" alt="">
								</a>
							</div>
							<div class="product-name-w3l">
								<h4>
	...
	<div class="footer-top">
		<div class="container-fluid">
			...
			<div class="col-xs-4 w3l-rightmk">
				<img src="<?php echo base_url(); ?>assets/include/images/tab3.png" alt=" ">
			</div>
			<div class="clearfix"></div>
		</div>
	</div>
		...
		<div class="container">
			...
			<div class="footer-info w3-agileits-info">
				...
				<div class="col-sm-2 footer-grids  w3l-socialmk">
					...
					<div class="agileits_app-devices">
						...
						<a href="#">
							<img src="<?php echo base_url(); ?>assets/include/images/1.png" alt="">
						</a>
						<a href="#">
							<img src="<?php echo base_url(); ?>assets/include/images/2.png" alt="">
						</a>
						<div class="clearfix"> </div>
					</div>
				</div>
			...
			<div class="agile-sometext">
				...
				<div class="sub-some child-momu">
					...
					<ul>
						<li>
							<img src="<?php echo base_url(); ?>assets/include/images/pay2.png" alt="">
						</li>
						<li>
							<img src="<?php echo base_url(); ?>assets/include/images/pay5.png" alt="">
						</li>
						<li>
							<img src="<?php echo base_url(); ?>assets/include/images/pay1.png" alt="">
						</li>
						<li>
							<img src="<?php echo base_url(); ?>assets/include/images/pay4.png" alt="">
						</li>
						<li>
							<img src="<?php echo base_url(); ?>assets/include/images/pay6.png" alt="">
						</li>
						<li>
							<img src="<?php echo base_url(); ?>assets/include/images/pay3.png" alt="">
						</li>
						<li>
							<img src="<?php echo base_url(); ?>assets/include/images/pay7.png" alt="">
						</li>
						<li>
							<img src="<?php echo base_url(); ?>assets/include/images/pay8.png" alt="">
						</li>
						<li>
							<img src="<?php echo base_url(); ?>assets/include/images/pay9.png" alt="">
						</li>
					</ul>
				</div>
				<!-- //payment -->
	...
	<!-- js-files -->
	<!-- jquery -->
	<script src="<?php echo base_url(); ?>assets/include/js/jquery-2.1.4.min.js"></script>
	<!-- //jquery -->

	<!-- popup modal (for signin & signup)-->
	<script src="<?php echo base_url(); ?>assets/include/js/jquery.magnific-popup.js"></script>
	<script>
	...
	<!-- cart-js -->
	<script src="<?php echo base_url(); ?>assets/include/js/minicart.js"></script>
	<script>
	...
	<script src="<?php echo base_url(); ?>assets/include/js/jquery-ui.js"></script>
	<script>
		//<![CDATA[ 
	...
	<script src="<?php echo base_url(); ?>assets/include/js/jquery.flexisel.js"></script>
	<script>
		$(window).load(function () {
	...
	<!-- smoothscroll -->
	<script src="<?php echo base_url(); ?>assets/include/js/SmoothScroll.min.js"></script>
	<!-- //smoothscroll -->

	<!-- start-smooth-scrolling -->
	<script src="<?php echo base_url(); ?>assets/include/js/move-top.js"></script>
	<script src="<?php echo base_url(); ?>assets/include/js/easing.js"></script>
	<script>
	...
	<script src="<?php echo base_url(); ?>assets/include/js/bootstrap.js"></script>
	<!-- //for bootstrap working -->
	<!-- //js-files -->
